...
public final class listar_005fperfil_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    location.href='gerenciar_perfil.do?acao=deletar&idperfil='+id;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("        \n");
      ...
      out.write("                <a href=\"form_perfil.jsp\">Adicionar Serviço<i class=\"material-symbols-outlined\">add</i></a>\n");
      out.write("            </div>\n");
      out.write("      \n");
      out.write("\n");
      out.write("            <table  class=\"table is-hoverable is-striped\" id=\"listarPerfil\">    \n");
      out.write("            <thead>\n");
      out.write("               <tr>\n");
      ...
      out.write("            \n");
      out.write("            ");
      model.PerfilDAO p = null;
      synchronized (_jspx_page_context) {
        p = (model.PerfilDAO) _jspx_page_context.getAttribute("p", PageContext.PAGE_SCOPE);
        if (p == null){
          p = new model.PerfilDAO();
      ...
      out.write("        <script src=\"./static/js/bulmadatatableperfil.js\"></script>\n");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems(new String("{$p.lista}"));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                   \n");
          out.write("            <tr>\n");
          out.write("                <td>{$p.idperfil}</td>\n");
          out.write("                <td>{$p.nome}</td>\n");
          out.write("                <td>R");
          ...
          out.write("</td>\n");
          out.write("                <td>{$p.descricao}</td>\n");
          out.write("                <td>{$p.status}</td>\n");
          out.write("                <td class=\"acoes-td\">\n");
          out.write("                    <button class=\"botao-acoes\" onclick=\"confirmarExclusão({$p.idperfil},'{$p.nome}')\">\n");
          out.write("                        <i class=\"material-symbols-outlined\">delete</i>\n");
          out.write("                    </button>\n");
          out.write("                    <a class=\"botao-acoes\" href=\"gerenciar_perfil.do?acao=alterar&idperfil={$p.idperfil}\">\n");
